                                    ...
                                    <div className="card">
                                        <div class="row no-gutters">
                                            ...
                                            <div className="col-md-8 card-body">
                                                ...
                                                { user && !wishlistItems?.includes(product.product._id) && <Button color='default' style={{ backgroundColor: '' }} className="bg-dark text-light btn btn-danger float-right m-0" onClick={() => addToWishlist()}> Add to Wishlist</Button>}
                                                </div>
                                                <div className="float-right m-2">
                                                { user && !cartItems?.includes(product.product._id) && <Button onClick={() => addToCart()} color='default' style={{ backgroundColor: '' }} className="bg-dark text-light btn btn-danger mt-0"><i className="fa fa-shopping-cart mr-2"></i> Add to Cart</Button>}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
